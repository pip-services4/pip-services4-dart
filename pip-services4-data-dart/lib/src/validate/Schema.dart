...
class Schema {
  ...
  void performTypeValidation(String? path, dynamic type, dynamic value,
    ...
    results.add(ValidationResult(
        ...
        'TYPE_MISMATCH',
        '$name type must be ${_typeToString(type)} but found ${_typeToString(valueType)}',
        type,
        valueType));
  }
  ...
  void validateAndThrowException(String? traceId, dynamic value,
      [bool strict = false]) {
    var results = validate(value);
