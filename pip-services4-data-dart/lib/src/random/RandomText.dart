...
class RandomText {
  ...
  static String fullName() {
    ...
    result +=
        '${RandomString.pick(RandomText._firstNames)} ${RandomString.pick(RandomText._lastNames)}';
  ...
  static String phone() {
    ...
    result +=
        '(${RandomInteger.nextInteger(111, 999)}) ${RandomInteger.nextInteger(111, 999)}-${RandomInteger.nextInteger(0, 9999)}';
