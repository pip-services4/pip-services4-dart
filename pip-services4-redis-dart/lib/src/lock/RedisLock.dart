...
///    ]));
///
///    await lock.open(Context.fromTraceId('123'));
///      ...
///
///    await lock.acquire(Context.fromTraceId('123'), 'key1');
///
///    try {
///        // Processing...
///    } finally {
///       await lock.releaseLock(Context.fromTraceId('123'), 'key1');
///        // Continue...
///    }
///```
class RedisLock extends Lock
  ...
  Future<bool> tryAcquireLock(IContext? context, String key, int ttl) async {
    if (!_checkOpened(context)) return false;
    var result =
