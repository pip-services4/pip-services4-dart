  ...
  group('DummyLambdaController', () {
    ...
    setUpAll(() async {
      var config = ConfigParams.fromTuples([
        ...
        'pip-services-dummies:controller:awslambda:default:1.0'
      ]);
    ...
    test('CRUD Operations', () async {
      ...
      // Create one dummy
      var result =
          await lambda.act({'cmd': 'dummies.create_dummy', 'dummy': DUMMY1});
      ...
      result =
          await lambda.act({'cmd': 'dummies.create_dummy', 'dummy': DUMMY2});
      ...
      result =
          await lambda.act({'cmd': 'dummies.update_dummy', 'dummy': dummy1});
      dummy = Dummy.fromJson(json.decode(result));
      expect(dummy, isNotNull);
