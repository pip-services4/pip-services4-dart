...
void main() {
  group('DummyAzureFunctionController', () {
    ...
    setUpAll(() async {
      var config = ConfigParams.fromTuples([
        ...
        'pip-services-dummies:controller:azurefunc:default:1.0'
      ]);
    ...
    test('CRUD Operations', () async {
      ...
      var result = await azureFunction
          .act({'cmd': 'dummies.create_dummy', 'dummy': DUMMY1});
      ...
      result = await azureFunction
          .act({'cmd': 'dummies.create_dummy', 'dummy': DUMMY2});
      ...
      result = await azureFunction
          .act({'cmd': 'dummies.update_dummy', 'dummy': dummy1});
      dummy = Dummy.fromJson(json.decode(result));
      expect(dummy, isNotNull);
