...
void main() {
  group('DummyCommandableAzureFunction', () {
    ...
    test('CRUD Operations', () async {
      ...
      var result = await azureFunction
          .act({'cmd': 'create_dummy', 'dummy': DUMMY1.toJson()});
      ...
      result = await azureFunction
          .act({'cmd': 'create_dummy', 'dummy': DUMMY2.toJson()});
      ...
      result = await azureFunction
          .act({'cmd': 'update_dummy', 'dummy': dummy1.toJson()});
      dummy = Dummy.fromJson(json.decode(result));
      expect(dummy, isNotNull);
