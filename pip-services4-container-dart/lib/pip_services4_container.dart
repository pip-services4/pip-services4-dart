...
///
/// Once the objects of a container are configured, if they implement the [IReferenceable interface](https://pub.dev/documentation/pip_services4_components/latest/pip_services4_components/IReferenceable-class.html),
/// they are passed a set of references for recreating links between objects in the container. If
/// objects implement the [IOpenable interface](https://pub.dev/documentation/pip_services4_components/latest/pip_services4_components/IOpenable-class.html),
...
/// starts to close, the objects that implement the [IClosable interface](https://pub.dev/documentation/pip_services4_components/latest/pip_services4_components/IClosable-class.html)
/// are closed via their
/// [close()] method (which should make them stop working and disconnect from other services),
/// after which objects that implement the [IUnreferenceable interface](https://pub.dev/documentation/pip_services4_components/latest/pip_services4_components/IUnreferenceable-class.html) delete various links between
/// objects, and, finally, the contains destroys all objects and turns off.

library pip_services4_container;
